...
**示例**：
"张建国是望都县黄庄村的一位资深农户，今年52岁，种了30多年地。老张家有45亩地，主要种冬小麦和夏玉米轮作。去年粮食收成不错，小麦亩产1100斤，玉米亩产1300斤，全年种地纯收入大概8万多元。家里有一台雷沃谷神收割机和一台东方红拖拉机，农忙时也帮邻居收割挣点外快。"
...
**工作流增强**：对于 `has_full_text=true` 且 relevance="高" 的政策，调用 `get_policy_document` 获取原文，在建议中引用具体条款（如"根据第二条补贴标准，您每亩可获得125元"）。
...
AI：[调用 get_farmer_by_phone...]
    ...
    [调用 write_output("narrative_profile", "张建国是望都县...")]
