...
function CreatorShell({ activePage, onNavigate, children }) {
  const shellStyles = {
    ...
    <div style={shellStyles.shell}>
      <div style={shellStyles.topbar}>
        ...
        <div style={shellStyles.navGroup}>
          {(onNavigate || window.__creatorNav) ? (
            <>
              <button style={shellStyles.navBtn(activePage === 'templates')} onClick={() => (onNavigate || window.__creatorNav)('templates')}>模板库</button>
              <button style={shellStyles.navBtn(activePage === 'builder')} onClick={() => (onNavigate || window.__creatorNav)('builder')}>课程构建</button>
            </>
          ) : (
            <>
