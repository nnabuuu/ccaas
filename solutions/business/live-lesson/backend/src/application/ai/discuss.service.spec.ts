  ...
  beforeAll(async () => {
    module = await Test.createTestingModule({
      ...
      providers: [
        ...
        ...PLUGIN_PROVIDERS,
        DiscussService,  AiPromptBuilder, ManifestCacheService, ClusterClassifier, ClusterAggregator, CoachingService, GradingService, StudentSubmissionService, StateCacheService,
