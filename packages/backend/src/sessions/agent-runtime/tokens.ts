...
export const WORKSPACE_ARTIFACT_SOURCE = 'WORKSPACE_ARTIFACT_SOURCE';
/**
 * DI token for the solution-provided `WorkspaceAccessResolver` (Phase 2b-2).
 ...
 */
export const WORKSPACE_ACCESS_RESOLVER = 'WORKSPACE_ACCESS_RESOLVER';
/**
 * The tenant-aware registry. `SessionAssetSyncer` injects this rather
 * than the single `WORKSPACE_ARTIFACT_SOURCE` token so it can route by
 ...
 * test injection).
 */
export const WORKSPACE_ARTIFACT_SOURCE_REGISTRY = 'WORKSPACE_ARTIFACT_SOURCE_REGISTRY';
/**
 ...
 */
export const WORKSPACE_BINARY_ARTIFACT_SOURCE_REGISTRY = 'WORKSPACE_BINARY_ARTIFACT_SOURCE_REGISTRY';
