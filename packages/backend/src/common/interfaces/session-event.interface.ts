/**
 * Session Event Interfaces
 *
 * Types for events sent to clients during a session.
 */
 ...
 * Agent status event
 */
export interface AgentStatusEvent extends SessionEvent {
  type: 'agent_status';
 ...
 */
export interface ChatResponseEvent extends SessionEvent {
  type: 'chat_response';
  text: string;
}
 ...
 * Tool activity event
 */
export interface ToolActivityEvent extends SessionEvent {
  type: 'tool_activity';
  payload: {
    toolName: string;
    toolId: string;
 ...
 */
export interface OutputUpdateEvent extends SessionEvent {
  type: 'output_update';
  payload: {
    data: unknown;
    status: string;
 ...
 */
export interface TodoUpdateEvent extends SessionEvent {
  type: 'todo_update';
  payload: {
    todos: Array<{
      content?: string;
 ...
 */
export interface ExplorationActivityEvent extends SessionEvent {
 ...
 * Token usage event
 */
export interface TokenUsageEvent extends SessionEvent {
  type: 'token_usage';
  payload: {
    inputTokens: number;
    outputTokens: number;
 ...
 */
export interface SessionRestoredEvent extends SessionEvent {
 ...
 */
export interface SessionNotFoundEvent extends SessionEvent {
