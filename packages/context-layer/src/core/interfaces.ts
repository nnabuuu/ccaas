...
export type EditOperation =
  ...
  | { op: 'field_set'; field: string; value: unknown }
  | { op: 'block_attr_set'; block_index: number; attributes: Record<string, unknown> }
  | { op: 'block_content_set'; block_index: number; field: string; value: unknown };
