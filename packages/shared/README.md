...
- **Types** (`@ccaas/shared/types`) - Core interfaces for sessions, messages, skills, tenants, etc.
- **Protocols** (`@ccaas/shared/protocols`) - Real-time event protocols for output updates
...
```typescript
// Just types
import { Session, Message, Skill } from '@ccaas/shared/types';

// Just protocols
import { OutputUpdateEvent, validateOutputUpdateEvent } from '@ccaas/shared/protocols';
```
...
```typescript
import { Session, SessionStatus, SessionSummary } from '@ccaas/shared/types';
...
```typescript
import { Message, ToolCall, ThinkingBlock } from '@ccaas/shared/types';
...
```typescript
import { Skill, SkillVersion, SkillTrigger } from '@ccaas/shared/types';
...
```typescript
import { ApiKey, ApiKeyScope } from '@ccaas/shared/types';
...
```typescript
import { mapFieldsToFrontend, mapFieldsToBackend } from '@ccaas/shared/protocols';
