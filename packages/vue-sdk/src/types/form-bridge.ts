 ...
 * Form Bridge Types
 *
 * Type definitions for AI agent to interact with Vue forms
...
/**
 * Form unregistration function type
 */
export type UnregisterAgentForm = (formId: string) => void
...
/**
 * Update source for form state changes
 */
export type FormUpdateSource = 'manual' | 'a2ui' | 'agent'
