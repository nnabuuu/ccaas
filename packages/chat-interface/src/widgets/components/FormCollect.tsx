        ...
        {props.fields.map((field) => (
          <div key={field.key} className="flex-1 min-w-[140px]">
            ...
            {field.type === 'select' && field.options ? (
              <select
                className="w-full px-[10px] py-[7px] border border-ck-b1 rounded-ck text-[13px] bg-ck-bg1 text-ck-t1 font-inherit"
              ...
              <button
                className={`px-3 py-[7px] rounded-ck text-[13px] border transition-all ${
