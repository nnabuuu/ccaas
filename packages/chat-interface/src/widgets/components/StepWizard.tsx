    ...
    <div className="border border-ck-b1 rounded-ck-lg bg-ck-bg1 p-4">
      ...
      <div className="flex gap-1 mb-5">
        {stepLabels.map((label, i) => (
          <button
            ...
            className={cn(
              'flex-1 text-center py-2 text-xs border-b-2 transition-all',
              i === currentStep
      ...
      <div className="flex gap-2 justify-end mt-4">
        {currentStep > 0 && (
          <button
            onClick={handlePrev}
            className="text-[13px] px-4 py-[7px] rounded-ck border border-ck-b1 bg-transparent text-ck-t2 hover:bg-ck-bg2"
          >
            &larr; Previous
          </button>
        )}
        {isLastStep ? (
          <button
            ...
            className="text-[13px] px-4 py-[7px] rounded-ck bg-ck-t1 text-ck-bg1 border border-ck-t1"
          >
