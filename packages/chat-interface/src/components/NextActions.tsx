    ...
    <div className="flex gap-1.5 flex-wrap mt-1">
      {actions.map((action, i) => (
        <button
          ...
          className={cn(
            'text-xs px-3 py-[5px] rounded-ck border font-inherit cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus-visible:ring-2 focus-visible:ring-ck-accent',
            i === 0
