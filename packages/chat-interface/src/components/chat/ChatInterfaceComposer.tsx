      ...
      <div className="max-w-3xl mx-auto relative rounded-[20px] bg-ck-bg1 shadow-composer hover:shadow-composer-hover focus-within:shadow-composer-focus transition-all duration-200">
        ...
        {isProcessing ? (
          <button
            ...
            className="absolute bottom-2.5 right-2.5 w-8 h-8 rounded-lg bg-ck-bg3 text-ck-t2 cursor-pointer flex items-center justify-center shrink-0 hover:bg-ck-b1 transition-colors active:scale-95"
            aria-label="停止生成"
          >
