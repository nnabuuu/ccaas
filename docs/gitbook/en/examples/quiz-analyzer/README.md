...
│                                  │
│  Tools:                          │
│  • batch_search_knowledge_points │  ← leafOnly mode
│  • get_children_nodes            │
...
The `leafOnly` algorithm in `batch_search_knowledge_points` solves this. See the full analysis in the sub-page below.
